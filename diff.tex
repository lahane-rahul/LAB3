...
% 1st. author
\alignauthor
\DIFdelbegin \DIFdel{Mukesh Saini}\DIFdelend \DIFaddbegin \DIFadd{Rahul Lahane}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \affaddr{National University of Singapore}\\
       \email{mksaini@comp.nus.edu.sg}
% 2nd. author
\alignauthor
\DIFdelbegin \DIFdel{Raghudeep Gadde}\DIFdelend \DIFaddbegin \DIFadd{Siddarth}\DIFaddend \\
       \affaddr{Dept. of ECE}\\
       \affaddr{National University of Singapore}\\
       \email{elerdg@nus.edu.sg}
\and 
% 3rd. author
\alignauthor \DIFdelbegin \DIFdel{Shuicheng Yan}\DIFdelend \DIFaddbegin \DIFadd{Ashish}\DIFaddend \\
       \affaddr{Dept. of ECE}\\
       \affaddr{National University of Singapore}\\
       \email{eleyans@nus.edu.sg}
 % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor \DIFdelbegin \DIFdel{Wei Tsang Ooi}\DIFdelend \DIFaddbegin \DIFadd{Mehta}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \affaddr{National University of Singapore}\\
...
\maketitle
\begin{abstract}
\DIFaddbegin \DIFadd{its the abstract}\\
...
\DIFaddbegin \DIFadd{HII intrcoduction}\\
